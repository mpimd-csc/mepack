...
SET (SRC ${CURDIR}/src/dummy.cpp)

ADD_LAPACK_SRC(dcombssq dcombssq.f scombssq.f)
ADD_LAPACK_SRC(daxpby   daxpby.f saxpby.f caxpby.f zaxpby.f)
ADD_LAPACK_SRC(dgebak   dgebak.f sgebak.f cgebak.f zgebak.f)
...
ADD_LAPACK_SRC(dgecon   dgecon.f sgecon.f cgecon.f zgecon.f)
...
ADD_LAPACK_SRC(dgeqp3   dgeqp3.f)
ADD_LAPACK_SRC(sgeqp3   sgeqp3.f)
ADD_LAPACK_SRC(cgeqp3   cgeqp3.f)
ADD_LAPACK_SRC(zgeqp3   zgeqp3.f)
...
ADD_LAPACK_SRC(dgeqrf   dgeqrf.f sgeqrf.f cgeqrf.f zgeqrf.f)
...
ADD_LAPACK_SRC(dgerqf   dgerqf.f sgerqf.f cgerqf.f zgeqrf.f)
ADD_LAPACK_SRC(dgesc2   dgesc2.f sgesc2.f cgesc2.f zgesc2.f)
ADD_LAPACK_SRC(dgesvj   dgesvj.f sgesvj.f cgesvj.f zgesvj.f)
ADD_LAPACK_SRC(dgsvj0   dgsvj0.f sgsvj0.f cgsvj0.f zgsvj0.f)
ADD_LAPACK_SRC(dgsvj1   dgsvj1.f sgsvj1.f cgsvj1.f zgsvj1.f)
...
ADD_LAPACK_SRC(dgges3   dgges3.f sgges3.f cgges3.f zgges3.f)
ADD_LAPACK_SRC(dgghd3   dgghd3.f sgghd3.f cgghd3.f zgghd3.f)
...
ADD_LAPACK_SRC(dlange   dlange.f slange.f clange.f zlange.f)
...
ADD_LAPACK_SRC(dorm22   dorm22.f sorm22.f)
...
ADD_LAPACK_SRC(zrot     zrot.f crot.f )
ADD_LAPACK_SRC(zunm22   zunm22.f cunm22.f)
ADD_LAPACK_SRC(zdrscl   csrscl.f zdrscl.f)
ADD_LAPACK_SRC(drscl    srscl.f drscl.f)
IF(SRC)
    ADD_LIBRARY(${LAPACK_MISSING_TARGET_NAME} OBJECT ${SRC})
    IF(LAPACK_MISSING_BUILD_LIBRARIES)
        ADD_LIBRARY(${LAPACK_MISSING_TARGET_NAME}_static STATIC $<TARGET_OBJECTS:${LAPACK_MISSING_TARGET_NAME}>)
        ADD_LIBRARY(${LAPACK_MISSING_TARGET_NAME}_shared SHARED $<TARGET_OBJECTS:${LAPACK_MISSING_TARGET_NAME}>)
    ENDIF()

    SET_TARGET_PROPERTIES(${LAPACK_MISSING_TARGET_NAME} PROPERTIES POSITION_INDEPENDENT_CODE TRUE LINKER_LANGUAGE Fortran )

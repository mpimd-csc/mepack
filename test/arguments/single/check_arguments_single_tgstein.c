...
typedef void (*tgstein_function) (const char *TRANSA, Int *M, float * A, Int *LDA, float *, Int *LDB, float *X, Int *LDX, float * SCALE, float *WORK, Int *INFO, FORTRAN_LEN_T l1);
...
int main(int argc, char **argv)
{
    ...
    struct function_name tgstein_functions[] = {
        { &(FC_GLOBAL_(sla_tgstein_l3,SLA_TGSTEIN_L3)), "SLA_TGSTEIN_L3", 1, 0,0 },
        { &(FC_GLOBAL_(sla_tgstein_l2,SLA_TGSTEIN_L2)), "SLA_TGSTEIN_L2", 0, 0 ,0 },
        { &(FC_GLOBAL_(sla_tgstein_dag,SLA_TGSTEIN_DAG)), "SLA_TGSTEIN_DAG", 1, 0, 0 },
        { &(FC_GLOBAL_(sla_tgstein_l3_2s,SLA_TGSTEIN_L3_2S)), "SLA_TGSTEIN_L3_2S",1 , 1 ,0},
        { &(FC_GLOBAL_(sla_tgstein_recursive,SLA_TGSTEIN_RECURSIVE)), "SLA_TGSTEIN_RECURSIVE", 0, 0 , 0},
        { NULL, NULL, 0,0, 0}
    };

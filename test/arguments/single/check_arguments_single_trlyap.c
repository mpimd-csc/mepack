...
#include "proto.h"
#include <string.h>
typedef void (*trlyap_function) (const char *TRANSA, Int *M, float * A, Int *LDA,float *X, Int *LDX, float * SCALE, float *WORK, Int *INFO, FORTRAN_LEN_T l1);
...
int main(int argc, char **argv)
{
    ...
    struct function_name trlyap_functions[] = {
        { &(FC_GLOBAL_(sla_trlyap_l3,SLA_TRLYAP_L3)), "SLA_TRLYAP_L3", 1, 0,0 },
        { &(FC_GLOBAL_(sla_trlyap_l2,SLA_TRLYAP_L2)), "SLA_TRLYAP_L2", 0, 0 ,0 },
        { &(FC_GLOBAL_(sla_trlyap_l2_opt,SLA_TRLYAP_L2_OPT)), "SLA_TRLYAP_L2_OPT", 0,0, 0 },
        { &(FC_GLOBAL_(sla_trlyap_dag,SLA_TRLYAP_DAG)), "SLA_TRLYAP_DAG", 1, 0, 0 },
        { &(FC_GLOBAL_(sla_trlyap_l3_2s,SLA_TRLYAP_L3_2S)), "SLA_TRLYAP_L3_2S",1 , 1 ,0},
        { &(FC_GLOBAL_(sla_trlyap_recursive,SLA_TRLYAP_RECURSIVE)), "SLA_TRLYAP_RECURSIVE", 0, 0 , 0},
        { NULL, NULL, 0,0, 0}
    };

...
#include "proto.h"
#include <string.h>
typedef void (*trstein_function) (const char *TRANSA, Int *M, float * A, Int *LDA,float *X, Int *LDX, float * SCALE, float *WORK, Int *INFO, FORTRAN_LEN_T l1);
...
int main(int argc, char **argv)
{
    ...
    struct function_name trstein_functions[] = {
        { &(FC_GLOBAL_(sla_trstein_l3,SLA_TRSTEIN_L3)), "SLA_TRSTEIN_L3", 1, 0,0 },
        { &(FC_GLOBAL_(sla_trstein_l2,SLA_TRSTEIN_L2)), "SLA_TRSTEIN_L2", 0, 0 ,0 },
        { &(FC_GLOBAL_(sla_trstein_dag,SLA_TRSTEIN_DAG)), "SLA_TRSTEIN_DAG", 1, 0, 0 },
        { &(FC_GLOBAL_(sla_trstein_l3_2s,SLA_TRSTEIN_L3_2S)), "SLA_TRSTEIN_L3_2S",1 , 1 ,0},
        { &(FC_GLOBAL_(sla_trstein_recursive,SLA_TRSTEIN_RECURSIVE)), "SLA_TRSTEIN_RECURSIVE", 0, 0 , 0},
        { NULL, NULL, 0,0, 0}
    };

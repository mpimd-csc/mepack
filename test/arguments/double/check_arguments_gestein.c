...
#include "proto.h"
#include <string.h>
typedef void (*trstein_function) (const char*FACT, const char *TRANSA, Int *M, double * A, Int *LDA, double *Q, Int *LDQ, double *X, Int *LDX, double * SCALE,
...
int main(int argc, char **argv)
{
    ...
    struct function_name trstein_functions[] = {
        { &(FC_GLOBAL_(dla_gestein,DLA_GESTEIN)), "DLA_GESTEIN", 1, MEPACK_FRONTEND_SOLVER_LEVEL3,0 },
        { &(FC_GLOBAL_(dla_gestein,DLA_GESTEIN)), "DLA_GESTEIN", 1, MEPACK_FRONTEND_SOLVER_LEVEL2,0 },
        { &(FC_GLOBAL_(dla_gestein,DLA_GESTEIN)), "DLA_GESTEIN", 1, MEPACK_FRONTEND_SOLVER_DAG,0 },
        { &(FC_GLOBAL_(dla_gestein,DLA_GESTEIN)), "DLA_GESTEIN", 1, MEPACK_FRONTEND_SOLVER_2STAGE,0 },
        { &(FC_GLOBAL_(dla_gestein,DLA_GESTEIN)), "DLA_GESTEIN", 1, MEPACK_FRONTEND_SOLVER_RECURSIVE,0 },
        { NULL, NULL, 0,0, 0}
    };

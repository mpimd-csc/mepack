...
int main(int argc, char **argv)
{
    ...
    struct function_name trsylv_functions[] = {
        { &(FC_GLOBAL_(dla_trsylv2_l3,DLA_TRSYLV2_L3)), "DLA_TRSYLV2_L3", 1, 0,0 },
        { &(FC_GLOBAL_(dla_trsylv2_l3_unopt,DLA_TRSYLV2_L3_UNOPT)), "DLA_TRSYLV2_L3_UNOPT", 1, 0,0  },
        { &(FC_GLOBAL_(dla_trsylv2_l2,DLA_TRSYLV2_L2)), "DLA_TRSYLV2_L2", 0, 0 ,0 },
        { &(FC_GLOBAL_(dla_trsylv2_l2_reorder,DLA_TRSYLV2_L2_REORDER)), "DLA_TRSYLV2_L2_REORDER", 0, 0,0  },
        { &(FC_GLOBAL_(dla_trsylv2_l2_local_copy,DLA_TRSYLV2_L2_LOCAL_COPY)), "DLA_TRSYLV2_L2_LOCAL_COPY" ,0 ,0,0  },
        { &(FC_GLOBAL_(dla_trsylv2_l2_local_copy_32,DLA_TRSYLV2_L2_LOCAL_COPY_32)), "DLA_TRSYLV2_L2_LOCAL_COPY_32", 0,0 , 1},
        { &(FC_GLOBAL_(dla_trsylv2_l2_local_copy_64,DLA_TRSYLV2_L2_LOCAL_COPY_64)), "DLA_TRSYLV2_L2_LOCAL_COPY_64", 0,0 , 1},
        { &(FC_GLOBAL_(dla_trsylv2_l2_local_copy_96,DLA_TRSYLV2_L2_LOCAL_COPY_96)), "DLA_TRSYLV2_L2_LOCAL_COPY_96", 0,0 , 1},
        { &(FC_GLOBAL_(dla_trsylv2_l2_local_copy_128,DLA_TRSYLV2_L2_LOCAL_COPY_128)), "DLA_TRSYLV2_L2_LOCAL_COPY_128", 0,0,1 },
        { &(FC_GLOBAL_(dla_trsylv2_l2_unopt,DLA_TRSYLV2_L2_UNOPT)), "DLA_TRSYLV2_L2_UNOPT", 0,0, 0 },
        { &(FC_GLOBAL_(dla_trsylv2_dag,DLA_TRSYLV2_DAG)), "DLA_TRSYLV2_DAG", 1, 0, 0 },
        { &(FC_GLOBAL_(dla_trsylv2_l3_2s,DLA_TRSYLV2_L3_2S)), "DLA_TRSYLV2_L3_2S",1 , 1 ,0},
        { &(FC_GLOBAL_(dla_trsylv2_recursive,DLA_TRSYLV2_RECURSIVE)), "DLA_TRSYLV2_RECURSIVE", 0, 0 , 0},
        { NULL, NULL, 0,0, 0}
    };

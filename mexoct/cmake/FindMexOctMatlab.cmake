...
ELSE()
    ...
    IF ( MEXOCT_MATLAB_BINARY AND MEXOCT_MEX_BINARY )
        ...
        SET(MEXOCT_MATLAB_ARCH_DIR "${MEXOCT_MATLAB_ROOT}/bin/${MEXOCT_MATLAB_ARCH_DIR}/")
        ...
        SET(MEXOCT_MATLAB_MEX ${MEXOCT_MATLAB_ROOT}/bin/mex)
...
function(mexoct_add_mex target)
  ...
  set_target_properties(${${target}_NAME}
    ...
    target_compile_definitions(${${target}_NAME} PRIVATE ${MEX_API_MACRO} ${MEX_COMPLEX_INTERLEAVE} "USE_MEX_CMD" "MATLAB_MEX_FILE" "MEXOCT_MATLAB=1")

*> \brief <b> CHGEES computes the eigenvalues, the Schur form, and,
*optionally, the matrix of Schur vectors for GE or HESS matrices</b>
*
*  =========== DOCUMENTATION ===========
*
* This is a modified version of LAPACK CGEES to allow an
* upper-Hessenberg form on input
*
* Online html documentation of CGEES available at
...
*  ===========
*
*       SUBROUTINE CHGEES( ASHAPE, JOBVS, SORT, SELECT, N, A, LDA, SDIM, W, VS,
...
*> \verbatim
*>
*> CHGEES computes for a matrix A,
*> which is either an N-by-N real nonsymmetric matrix or
*> an upper Hessenberg matrix, the eigenvalues, the Schur form T,
...
*
*  =====================================================================
      SUBROUTINE chgees( ASHAPE, JOBVS, SORT, SELECT, N, A, LDA, SDIM,
...
*
      ...
      END IF
*
      CALL chseqr( 'S', compz, n, ilo, ihi, a, lda, w, vs, ldvs,

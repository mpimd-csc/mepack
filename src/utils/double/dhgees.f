*> \brief <b> DHGEES computes the eigenvalues, the Schur form, and,
* optionally, the matrix of Schur vectors for GE or HESS matrices</b>
*
*  =========== DOCUMENTATION ===========
*
* This is a modified version of LAPACK DGEES to allow an
* upper-Hessenberg form on input
*      
* Online html documentation of DGEES available at
...
*  ===========
*
*       SUBROUTINE DHGEES( ASHAPE, JOBVS, SORT, SELECT, N, A, LDA, SDIM, WR, WI,
...
*> \verbatim
*>
*> DHGEES computes for a matrix A,
...
*
*  =====================================================================
      SUBROUTINE DHGEES( ASHAPE, JOBVS, SORT, SELECT, N, A, LDA, SDIM,
...
*
      ...
      END IF
*
      CALL DHSEQR( 'S', COMPZ, N, ILO, IHI, A, LDA, WR, WI, VS, LDVS,

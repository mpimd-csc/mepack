        ...
        DO WHILE (K .GT. 0)
            ...
            DO
                ...
                IF ( IT .EQ. 0 ) THEN
                    ...
                    ELSE
                        CALL SLA_SMALL_SOLVE4( DIMMAT, MAT4, RHS, INFO1, MACHINE_PRECISION, SMALL_NUMBER)
                    END IF
                    IF ( INFO1 .EQ. 0 ) EXIT
                    IT = 1
                ELSE
                    IF (DIMMAT .EQ. 8) THEN
                        ...
                        CALL SGESC2(DIMMAT, MAT, 8, MAT(1,9), IPIV, JPIV, SCAL)
                    ELSE
                        CALL SGETC2X(DIMMAT, MAT4, 4, IPIV, JPIV, INFO1)
                        IF ( INFO1 .NE. 0 ) INFO = INFO1
                        CALL SGESC2(DIMMAT, MAT4, 4, RHS, IPIV, JPIV, SCAL)

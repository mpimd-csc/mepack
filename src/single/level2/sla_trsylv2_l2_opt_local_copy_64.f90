...
!> \verbatim
!>
!> SLA_TRSYLV2_L2_LOCAL_COPY_64 solves a generalized Sylvester equation of the following forms
!>
...
!> \ingroup sgltrsylv
!
SUBROUTINE SLA_TRSYLV2_L2_LOCAL_COPY_64( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, X, LDX, SCALE, &
        & WORK, INFO)

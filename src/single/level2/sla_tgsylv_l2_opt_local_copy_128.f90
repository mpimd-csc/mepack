...
!  ===========
!
!       SUBROUTINE SLA_TGSYLV_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, &
!                        & SCALE, WORK, INFO)
...
!> \ingroup sgltgsylv
!
SUBROUTINE SLA_TGSYLV_L2_LOCAL_COPY_128( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, &
        & WORK, INFO)

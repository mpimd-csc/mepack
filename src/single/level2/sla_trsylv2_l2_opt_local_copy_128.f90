...
!> \verbatim
!>
!> SLA_TRSYLV2_L2_LOCAL_COPY_128 solves a generalized Sylvester equation of the following forms
!>
...
!> \ingroup sgltrsylv
!
SUBROUTINE SLA_TRSYLV2_L2_LOCAL_COPY_128( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, X, LDX, SCALE, &
        & WORK, INFO)
    ...
    INTEGER MAXNB
    PARAMETER(MAXNB = 128)
    INCLUDE 'sla_trsylv2_l2_opt_local_copy_xx.f90'

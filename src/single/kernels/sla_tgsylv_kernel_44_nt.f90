...
!  ===========
!
!       SUBROUTINE SLA_TGSYLV_KERNEL_44NT (SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, INFO)
!           REAL SGN, SCALE
...
!> \verbatim
!>
!> SLA_TGSYLV_KERNEL_44NT solves a generalized Sylvester equation of the following form
!>

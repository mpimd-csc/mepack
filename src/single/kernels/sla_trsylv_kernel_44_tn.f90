...
!> \brief Solver for a 4x4 Sylvester equation (TRANSA = T, TRANSB = N)
!
!  Definition:
!  ===========
!
...
!> \verbatim
!>
!> SLA_TRSYLV_KERNEL_44TN solves a Sylvester equation of the following form
!>
!>    A**T * X  + SGN * X * B = SCALE * Y                              (1)
!>

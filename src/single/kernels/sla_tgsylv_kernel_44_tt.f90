...
!  ===========
!
!       SUBROUTINE SLA_TGSYLV_KERNEL_44TT (SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, INFO)
!           REAL SGN, SCALE
...
!> \verbatim
!>
!> SLA_TGSYLV_KERNEL_44TT solves a generalized Sylvester equation of the following form
!>

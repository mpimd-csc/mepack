...
!> \brief Solver for a 4x4 generalized coupled Sylvester equation (TRANSA = T, TRANSB = T)
!
!  Definition:
!  ===========
!
!       SUBROUTINE SLA_TGCSYLV_KERNEL_44TT (SGN1, SGN2, M, N, A, LDA, B, LDB, C, LDC, D, LDD, E, LDE, F, LDF, SCALE, INFO)
...
!> \verbatim
!>
!> SLA_TGCSYLV_KERNEL_44NN solves a generalized Sylvester equation of the following form
!>
!>    A**T * R  + SGN1 * L * B**T = SCALE * E                              (1)
!>    C**T * R  + SGN2 * L * D**T = SCALE * F                              (1)
!>

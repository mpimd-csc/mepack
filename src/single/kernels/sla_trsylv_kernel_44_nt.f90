...
!> \brief Solver for a 4x4 Sylvester equation (TRANSA = N, TRANSB = T)
!
!  Definition:
!  ===========
!
...
!> \verbatim
!>
!> SLA_TRSYLV_KERNEL_44NT solves a Sylvester equation of the following form
!>
!>    A * X  + SGN * X * B**T = SCALE * Y                              (1)
!>
...
!> M-by-N matrices. Typically the matrices A and B are create by SGEES from LAPACK.
!> The algorithm is implemented using without BLAS level 2

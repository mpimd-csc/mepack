...
!>
!> \verbatim
!> SLA_TRSYLV_L3 solves a Sylvester equation of the following forms
!>
...
SUBROUTINE SLA_TRSYLV_L3 ( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, X, LDX, SCALE, WORK, INFO)
    ...
    IF ( INFO .LT. 0 ) THEN
        CALL XERROR_HANDLER('SLA_TRSYLV_L3', -INFO)
        RETURN
    END IF
    ...
    IF ( .NOT. BTRANSA .AND. .NOT. BTRANSB ) THEN
        ...
        DO WHILE ( LH .LE. N )
            ...
            IF ( LH .LT. N  ) THEN
                ...
                !        JB = JH - J + 1
                !
                !        CALL SGEMM("N", "N", M, JB, LB, -SGN*ONE, X(1,L), LDX, B(L,J), LDB, ONE, X(1,J), LDX)

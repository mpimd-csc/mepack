...
!
!> \brief Level-3 Bartels-Stewart Algorithm for the discrete time  Sylvester equation (Not Optimized)
!
!  Definition:
!  ===========
!
...
!> \verbatim
!>
!> SLA_TRSYLV2_L3_UNOPT solves a generalized Sylvester equation of the following forms
!>
...
!> \endverbatim
!> \attention This function iterates column first over the result and from this fact it will be a bit slower than
!> SLA_TRSYLV2_L3.
!>
!
!  Arguments:
...
SUBROUTINE SLA_TRSYLV2_L3_UNOPT ( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, X, LDX, SCALE, WORK, INFO)
    ...
    IF ( INFO .LT. 0 ) THEN
        CALL XERROR_HANDLER('SLA_TRSYLV2_L3_UNOPT', -INFO)
        RETURN
    END IF

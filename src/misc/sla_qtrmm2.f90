        ...
        IF (TRANS.EQ.'N') THEN
            DO I = 1,M-1
                IF (A(I+1,I).NE.ZERO) THEN
                    CALL SAXPY(N, ALPHA*A(I+1,I), B(I,1), LDB, C(I+1,1), LDC)
                END IF
            END DO
        ELSE
            DO I = 1,M-1
                IF (A(I+1,I).NE.ZERO) THEN
                    CALL SAXPY(N, ALPHA*A(I+1,I), B(I+1,1), LDB, C(I,1), LDC)
                END IF
            END DO
        END IF
    ELSE
        IF (TRANS.EQ.'N') THEN
            DO I = 1,N-1
                IF (A(I+1,I).NE. ZERO) THEN
                    CALL SAXPY(M, ALPHA*A(I+1,I), B(1,I+1), 1, C(1,I), 1)
                END IF
            END DO
        ELSE
            DO I = 1,N-1
                IF (A(I+1,I).NE.ZERO) THEN
                    CALL SAXPY(M, ALPHA*A(I+1,I), B(1,I), 1, C(1,I+1), 1)
                END IF
            END DO
        END IF
    END IF

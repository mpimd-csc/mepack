...
!  Definition:
!  ===========
!       SUBROUTINE DLA_TGCSYLV_L3 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
...
SUBROUTINE DLA_TGCSYLV_L3 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
    ...
    IF ( INFO .LT. 0 ) THEN
        CALL XERROR_HANDLER('DLA_TGCSYLV_L3', -INFO)
        RETURN
    END IF
        ...
        DO WHILE ( LH .LE. N )
            ...
            DO WHILE (K .GT. 0)
                ...
                IF ( K .GT. 1 ) THEN
                    ...
                    CALL DGEMM('N', 'N', K-1, LB, KB, -ONE, C(1,K), LDC, E(K,L), LDE, ONE, F(1,L), LDF)
                END IF
            ...
            ! Update January 2021
            IF ( LH .LT. N  ) THEN
                CALL DGEMM("N", "N", M, N-LH, LB, -ONE*SGN1, F(1,L), LDF, B(L,LH+1), LDB, ONE, E(1,LH+1), LDE)
        ...
        DO WHILE ( L .GT. 0 )
            ...
            DO WHILE (K .GT. 0)
                ...
                IF ( K .GT. 1 ) THEN
                    ...
                    CALL DGEMM('N', 'N', KE, LB, KB, -ONE, C(1,K), LDC, E(K,L), LDE, ONE, F(1,L), LDF)
                END IF
            ...
            ! Update January 2021
            IF ( L .GT. 1 ) THEN
                CALL DGEMM('N', 'T', M, LE, LB, -ONE*SGN1, F(1,L), LDF, B(1,L), LDB, ONE, E(1,1), LDE)
        ...
        DO WHILE ( LH .LE. N )
            ...
            DO WHILE ( KH .LE. M )
                ...
                IF ( KH  .LT. M ) THEN
                    ...
                    CALL DGEMM("T", "N", M-KH, LB, KB, -ONE, C(K,KH+1), LDC, E(K,L), LDE, ONE, F(KH+1, L), LDF)
                END IF

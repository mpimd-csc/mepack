...
!  ===========
!
!       SUBROUTINE DLA_TGCSYLV_KERNEL_44NT (SGN1, SGN2, M, N, A, LDA, B, LDB, C, LDC, D, LDD, E, LDE, F, LDF, SCALE, INFO)
...
!> \verbatim
!>
!> DLA_TGCSYLV_KERNEL_44NT solves a generalized Sylvester equation of the following form
!>

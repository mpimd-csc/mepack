...
!  ===========
!
!       SUBROUTINE DLA_TGSYLV_KERNEL_44TN (SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, INFO)
...
!> \verbatim
!>
!> DLA_TGSYLV_KERNEL_44TN solves a generalized Sylvester equation of the following form
!>

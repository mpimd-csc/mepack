...
!  Definition:
!  ===========
!       SUBROUTINE DLA_TGCSYLV_DUAL_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
...
!>         the input data. For this reason M and N are limited to 128. Furthermore, the algorithm uses alignment of the local arrays
...
SUBROUTINE DLA_TGCSYLV_DUAL_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
    ...
    INTEGER MAXNB
    PARAMETER(MAXNB = 128)
    INCLUDE 'dla_tgcsylv_dual_l2_opt_local_copy_xx.f90'
END SUBROUTINE

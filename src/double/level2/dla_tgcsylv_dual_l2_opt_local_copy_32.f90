...
!  Definition:
!  ===========
!       SUBROUTINE DLA_TGCSYLV_DUAL_L2_LOCAL_COPY_32 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
...
!>         the input data. For this reason M and N are limited to 32. Furthermore, the algorithm uses alignment of the local arrays

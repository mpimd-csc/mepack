...
!  ===========
!
!       SUBROUTINE DLA_TGSYLV_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, &
!                        & SCALE, WORK, INFO)
...
!> \li DTRMV works purely sequential
!> \li Align local copies and fix problem size to <= 128
!
!
!  Authors:
!  ========
...
!> \ingroup dbltgsylv
!
SUBROUTINE DLA_TGSYLV_L2_LOCAL_COPY_128( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, &
        & WORK, INFO)
    ...
    INTEGER MAXNB
    PARAMETER(MAXNB = 128)
    INCLUDE 'dla_tgsylv_l2_opt_local_copy_xx.f90'

...
!  ===========
!
!       SUBROUTINE DLA_TGSYLV_L2_LOCAL_COPY_96 ( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, &
!                        & SCALE, WORK, INFO)
...
!> \ingroup dbltgsylv
!
SUBROUTINE DLA_TGSYLV_L2_LOCAL_COPY_96( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, C, LDC, D, LDD, X, LDX, SCALE, &
        & WORK, INFO)

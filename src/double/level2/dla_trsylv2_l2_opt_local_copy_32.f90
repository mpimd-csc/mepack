...
!> \verbatim
!>
!> DLA_TRSYLV2_L2_LOCAL_COPY_32 solves a generalized Sylvester equation of the following forms
!>
...
!> \ingroup dbltrsylv
!
SUBROUTINE DLA_TRSYLV2_L2_LOCAL_COPY_32( TRANSA, TRANSB, SGN, M, N, A, LDA, B, LDB, X, LDX, SCALE, &
        & WORK, INFO)

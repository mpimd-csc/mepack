...
!  Definition:
!  ===========
!       SUBROUTINE DLA_TGCSYLV_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
...
!> \endverbatim
!> \remark The algorithm is implemented using BLAS level 2 operations and hand written optimizations and aligned local copies.
!>
!
!  Arguments:
!  ==========
...
SUBROUTINE DLA_TGCSYLV_L2_LOCAL_COPY_128 ( TRANSA, TRANSB, SGN1, SGN2,  M, N, A, LDA, B, LDB, C, LDC, D, LDD, &
    ...
    INTEGER MAXNB
    PARAMETER(MAXNB = 128)
    INCLUDE 'dla_tgcsylv_l2_opt_local_copy_xx.f90'
 END SUBROUTINE

...
SUBROUTINE DLA_TGLYAP_L2 ( TRANS, M, A, LDA, B, LDB, X, LDX, SCALE, WORK, INFO)
    ...
    IF ( INFO .LT. 0 ) THEN
        CALL XERROR_HANDLER('DLA_TGLYAP_L2', -INFO)
        RETURN
    END IF
        ...
        DO WHILE ( L .LE. M )
            ...
            IF ( LH .LT. M ) THEN
                IF ( LB .EQ. IONE ) THEN
                    ...
                    CALL DSYR2("L", M-LH, -ONE, WORK, IONE, WORK(2*M+1), IONE, X(LH+1, LH+1), LDX)
                    ...
                    CALL DSYR2("L", M-LH, -ONE, WORK(2*M+1), IONE, WORK, IONE, X(LH+1,LH+1), LDX)
                ...
                ELSE
                    ...
                    CALL DSYR2("L", M-LH, -ONE, WORK, IONE, WORK(2*M+1), IONE, X(LH+1, LH+1), LDX)
                    CALL DSYR2("L", M-LH, -ONE, WORK(M+1), IONE, WORK(3*M+1), IONE, X(LH+1, LH+1), LDX)
                    ...
                    CALL DSYR2("L", M-LH, -ONE, WORK(2*M+1), IONE, WORK, IONE, X(LH+1,LH+1), LDX)
                    CALL DSYR2("L", M-LH, -ONE, WORK(3*M+1), IONE, WORK(M+1), IONE, X(LH+1,LH+1), LDX)

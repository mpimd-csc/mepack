            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trsylv_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (NB.LT.1 .OR. INFO .NE. 0) THEN
                        NB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trsylv_double_nb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    NB = 64
                END IF
        ...
        FUNCTION TRSYLV2_BLOCKSIZE_MB(M,N) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trsylv2_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TRSYLV2_BLOCKSIZE_NB(M,N) RESULT(NB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (NB.LT.1 .OR. INFO .NE. 0) THEN
                        NB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trsylv2_double_nb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    NB = 64
                END IF
        ...
        FUNCTION TGSYLV_BLOCKSIZE_MB(M,N) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgsylv_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TGSYLV_BLOCKSIZE_NB(M,N) RESULT(NB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (NB.LT.1 .OR. INFO .NE. 0) THEN
                        NB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgsylv_double_nb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    NB = 64
                END IF
        ...
        FUNCTION TGCSYLV_BLOCKSIZE_MB(M,N) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgcsylv_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TGCSYLV_BLOCKSIZE_NB(M,N) RESULT(NB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (NB.LT.1 .OR. INFO .NE. 0) THEN
                        NB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgcsylv_double_nb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    NB = 64
                END IF
        ...
        FUNCTION TGCSYLV_DUAL_BLOCKSIZE_MB(M,N) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgcsylv_dual_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TGCSYLV_DUAL_BLOCKSIZE_NB(M,N) RESULT(NB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (NB.LT.1 .OR. INFO .NE. 0) THEN
                        NB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgcsylv_dual_double_nb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    NB = 64
                END IF
        ...
        FUNCTION TRLYAP_BLOCKSIZE(M) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trlyap_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TRSTEIN_BLOCKSIZE(M) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(trstein_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TGLYAP_BLOCKSIZE(M) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tglyap_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF
        ...
        FUNCTION TGSTEIN_BLOCKSIZE(M) RESULT(MB)
            ...
            ELSE
                IF ( LUA_LOADED() .EQ. 1 ) THEN
                    ...
                    IF (MB.LT.1 .OR. INFO .NE. 0) THEN
                        MB = 64
                        WRITE(*,*) "MEPACK_LUA_CONFIG(tgstein_double_mb) returned a blocksize lower than 1 or failed. Use 64."
                    END IF
                ELSE
                    MB = 64
                END IF

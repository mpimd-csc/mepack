...
/**
 ...
 \remark This function is a wrapper around \ref dla_tglyap_l3.
 ...
 \date October 2023
 */
void mepack_double_tglyap_level3(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tglyap_l3,DLA_TGLYAP_L3)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \brief Level-3 Bartels-Stewart Algorithm with sub-blocking for the generalized Lyapunov equation
 ...
 \remark This function is a wrapper around \ref dla_tglyap_l3_2s.
 ...
 \date October 2023
 */
void mepack_double_tglyap_level3_2stage(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    Int _M   = M;
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(dla_tglyap_l3_2s,DLA_TGLYAP_L3_2S)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_l3.
 ...
 \date October 2023
 */
void mepack_single_tglyap_level3(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tglyap_l3,SLA_TGLYAP_L3)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_l3_2s.
 ...
 \date October 2023
 */
void mepack_single_tglyap_level3_2stage(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    Int _M   = M;
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(sla_tglyap_l3_2s,SLA_TGLYAP_L3_2S)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);

...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv2_l3.
...
void mepack_double_trsylv2_level3(const char *TRANSA, const char *TRANSB, double SGN,  int M, int N,
                                 ...
                                 double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trsylv2_l3,DLA_TRSYLV2_L3)(TRANSA, TRANSB, &SGN, &_M, &_N,
...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv2_l3_unopt.

 \see dla_trsylv2_l3_unopt
 ...
 \date Januar 2023
*/
void mepack_double_trsylv2_level3_unopt(const char *TRANSA, const char *TRANSB, double SGN,  int M, int N,
                                 double * A, int LDA, double * B, int LDB, double *X, int LDX,
                                 double * SCALE, double *WORK, int *INFO)
{
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(dla_trsylv2_l3_unopt,DLA_TRSYLV2_L3_UNOPT)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}
...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv2_l3_2s.
 ...
 \date Januar 2023
*/
void mepack_double_trsylv2_level3_2stage(const char *TRANSA, const char *TRANSB, double SGN,  int M, int N,
                                 double * A, int LDA, double * B, int LDB, double *X, int LDX,
                                 double * SCALE, double *WORK, int *INFO)
{
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(dla_trsylv2_l3_2s,DLA_TRSYLV2_L3_2S)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv2_l3.
 ...
 \date Januar 2023
*/
void mepack_single_trsylv2_level3(const char *TRANSA, const char *TRANSB, float SGN,  int M, int N,
                                 ...
                                 float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_trsylv2_l3,SLA_TRSYLV2_L3)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv2_l3_unopt.

 \see sla_trsylv2_l3_unopt
...
void mepack_single_trsylv2_level3_unopt(const char *TRANSA, const char *TRANSB, float SGN,  int M, int N,
                                 float * A, int LDA, float * B, int LDB, float *X, int LDX,
                                 float * SCALE, float *WORK, int *INFO)
{
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(sla_trsylv2_l3_unopt,SLA_TRSYLV2_L3_UNOPT)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv2_l3_2s.
 ...
 \date Januar 2023
*/
void mepack_single_trsylv2_level3_2stage(const char *TRANSA, const char *TRANSB, float SGN,  int M, int N,
                                 float * A, int LDA, float * B, int LDB, float *X, int LDX,
                                 float * SCALE, float *WORK, int *INFO)
{
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(sla_trsylv2_l3_2s,SLA_TRSYLV2_L3_2S)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}

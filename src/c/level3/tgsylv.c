...
/**
 ...
 \remark This function is a wrapper for \ref dla_tgsylv_l3.
        ...
        double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgsylv_l3,DLA_TGSYLV_L3)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 \brief Level-3 Bartels-Stewart Algorithm for the generalized Sylvester equation (Row-by-row variant)
 ...
 \remark This function is a wrapper for \ref dla_tgsylv_l3_rowwise.

 \see dla_tgsylv_l3_rowwise
        ...
        double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgsylv_l3_rowwise,DLA_TGSYLV_L3_ROWWISE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 \brief Level-3 Bartels-Stewart Algorithm for the generalized Sylvester equation (Column-by-Column variant)
 ...
 \remark This function is a wrapper for \ref dla_tgsylv_l3_colwise.

 \see dla_tgsylv_l3_colwise
        ...
        double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgsylv_l3_colwise,DLA_TGSYLV_L3_COLWISE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 ...
 \remark This function is a wrapper for \ref dla_tgsylv_l3_2s.
        ...
        double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgsylv_l3_2s,DLA_TGSYLV_L3_2S)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 \brief Level-3 Bartels-Stewart Algorithm for the generalized Sylvester
 ...
 \remark This function is a wrapper for \ref sla_tgsylv_l3.
        ...
        float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgsylv_l3,SLA_TGSYLV_L3)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 \brief Level-3 Bartels-Stewart Algorithm for the generalized Sylvester (Row-by-row variant)
 ...
 \remark This function is a wrapper for \ref sla_tgsylv_l3_rowwise.

 \see sla_tgsylv_l3_rowwise
        ...
        float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgsylv_l3_rowwise,SLA_TGSYLV_L3_ROWWISE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 \brief Level-3 Bartels-Stewart Algorithm for the generalized Sylvester (Column-by-column variant)
 ...
 \remark This function is a wrapper for \ref sla_tgsylv_l3_colwise.
        ...
        float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgsylv_l3_colwise,SLA_TGSYLV_L3_COLWISE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
...
/**
 \brief Level-3 Bartels-Stewart Algorithm with sub-blocking for the generalized Sylvester
 ...
 \remark This function is a wrapper for \ref sla_tgsylv_l3_2s.
        ...
        float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgsylv_l3_2s,SLA_TGSYLV_L3_2S)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);

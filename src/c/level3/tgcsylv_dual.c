...
/**
 ...
 \remark This function is a wrapper for \ref dla_tgcsylv_dual_l3.

 \see dla_tgcsylv_dual_l3
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_dual_l3,DLA_TGCSYLV_DUAL_L3)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 ...
 \remark This function is a wrapper for \ref sla_tgcsylv_dual_l3.

 \see sla_tgcsylv_dual_l3
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_dual_l3,SLA_TGCSYLV_DUAL_L3)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-3 with sub blocking Kagstroem-Westin/Bartels-Stewart Algorithm for the dual generalized coupled Sylvester equation
...
mepack_double_tgcsylv_dual_level3_2stage solves a generalized coupled  Sylvester equation of the following form
 ...
 \remark This function is a wrapper for \ref dla_tgcsylv_dual_l3_2s.
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_dual_l3_2s,DLA_TGCSYLV_DUAL_L3_2S)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark This function is a wrapper for \ref sla_tgcsylv_dual_l3_2s.
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_dual_l3_2s,SLA_TGCSYLV_DUAL_L3_2S)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;

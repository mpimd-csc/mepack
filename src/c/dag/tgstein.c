...
/**
 ...
 \remark This function is a wrapper around \ref dla_tgstein_dag.
 ...
 \date October 2023
 */
void mepack_double_tgstein_dag(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgstein_dag,DLA_TGSTEIN_DAG)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tgstein_dag.
 ...
 \date October 2023
 */
void mepack_single_tgstein_dag(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgstein_dag,SLA_TGSTEIN_DAG)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);

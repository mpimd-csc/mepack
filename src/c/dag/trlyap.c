...
/**
 ...
 \remark This function is a wrapper around \ref dla_trlyap_dag
...
void mepack_double_trlyap_dag(const char *TRANS, int M, double * A, int LDA, double *X, int LDX, double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trlyap_dag,DLA_TRLYAP_DAG)(TRANS, &_M, A, &_LDA, X, &_LDX, SCALE, WORK, &_INFO, c1len);
    *INFO = (int) _INFO;
    return;
}
...
/**
 ...
 \remark The algorithm is implemented using DAG Scheduling
 \remark This function is a wrapper around \ref sla_trlyap_dag
...
void mepack_single_trlyap_dag(const char *TRANS, int M, float * A, int LDA, float *X, int LDX, float * SCALE, float *WORK, int *INFO)
{
    ...
    Int _INFO = *INFO;
    FORTRAN_LEN_T c1len = strlen(TRANS);
    FC_GLOBAL_(sla_trlyap_dag,SLA_TRLYAP_DAG)(TRANS, &_M, A, &_LDA, X, &_LDX, SCALE, WORK, &_INFO, c1len);
    *INFO = (int) _INFO;
    return;
}
/**

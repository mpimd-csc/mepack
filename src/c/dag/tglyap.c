...
/**
 ...
 \remark This function is a wrapper around \ref dla_tglyap_dag.
 ...
 \date Dezember 2022
 */
void mepack_double_tglyap_dag(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tglyap_dag,DLA_TGLYAP_DAG)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_dag.
 ...
 \date Dezember 2022
 */
void mepack_single_tglyap_dag(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tglyap_dag,SLA_TGLYAP_DAG)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);

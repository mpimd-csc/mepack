...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv_dag.
                                 ...
                                 double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trsylv_dag,DLA_TRSYLV_DAG)(TRANSA, TRANSB, &SGN, &_M, &_N,
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv_dag.
                                 ...
                                 float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_trsylv_dag,SLA_TRSYLV_DAG)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}

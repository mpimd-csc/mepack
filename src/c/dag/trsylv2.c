...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv2_dag.
 ...
 \date October 2023
*/
void mepack_double_trsylv2_dag(const char *TRANSA, const char *TRANSB, double SGN,  int M, int N,
                                 ...
                                 double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trsylv2_dag,DLA_TRSYLV2_DAG)(TRANSA, TRANSB, &SGN, &_M, &_N,
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv2_dag.
...
void mepack_single_trsylv2_dag(const char *TRANSA, const char *TRANSB, float SGN,  int M, int N,
                                 ...
                                 float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_trsylv2_dag,SLA_TRSYLV2_DAG)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}

...
/**
 ...
 \remark The routine is a wrapper around \ref dla_trstein_l2.
...
void mepack_double_trstein_level2(const char *TRANSA, int M, double * A, int LDA, double *X, int LDX, double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trstein_l2,DLA_TRSTEIN_L2)(TRANSA, &_M, A, &_LDA, X, &_LDX, SCALE, WORK, &_INFO, c1len);
    *INFO =(int) _INFO;
    return;
}
...
/**
 ...
 \remark The routine is a wrapper around \ref sla_trstein_l2.
...
void mepack_single_trstein_level2(const char *TRANSA, int M, float * A, int LDA, float *X, int LDX, float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_trstein_l2,SLA_TRSTEIN_L2)(TRANSA, &_M, A, &_LDA, X, &_LDX, SCALE, WORK, &_INFO, c1len);
    *INFO =(int) _INFO;
    return;
}

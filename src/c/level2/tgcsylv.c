 ...
 */
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2
...
void mepack_double_tgcsylv_level2(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_l2,DLA_TGCSYLV_L2)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Unoptimized variant)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_unopt
...
void mepack_double_tgcsylv_level2_unopt(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        double * A, int LDA,double * B, int LDB, double *C, int LDC, double *D, int LDD,
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_unopt,DLA_TGCSYLV_L2_UNOPT)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Reordered variant)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_reorder
...
void mepack_double_tgcsylv_level2_reorder(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        double * A, int LDA,double * B, int LDB, double *C, int LDC, double *D, int LDD,
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_reorder,DLA_TGCSYLV_L2_REORDER)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Local copies, unaligned)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_local_copy
...
void mepack_double_tgcsylv_level2_local_copy(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        double * A, int LDA,double * B, int LDB, double *C, int LDC, double *D, int LDD,
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_local_copy,DLA_TGCSYLV_L2_LOCAL_COPY)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Local copies, M,N<=32)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_local_copy_32
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_local_copy_32,DLA_TGCSYLV_L2_LOCAL_COPY_32)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Local copies, M,N<=64)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_local_copy_64
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_local_copy_64,DLA_TGCSYLV_L2_LOCAL_COPY_64)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Local copies, M,N<=96)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_local_copy_96
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_local_copy_96,DLA_TGCSYLV_L2_LOCAL_COPY_96)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 \brief Level-2 Kagstroem-Westin/Bartels-Stewart Algorithm for the generalized coupled Sylvester equation (Local copies, M,N<=128)
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_l2_local_copy_128
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_l2_local_copy_128,DLA_TGCSYLV_L2_LOCAL_COPY_128)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2
...
void mepack_single_tgcsylv_level2(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_l2,SLA_TGCSYLV_L2)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_unopt
...
void mepack_single_tgcsylv_level2_unopt(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        float * A, int LDA,float * B, int LDB, float *C, int LDC, float *D, int LDD,
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_unopt,SLA_TGCSYLV_L2_UNOPT)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_reorder
...
void mepack_single_tgcsylv_level2_reorder(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        float * A, int LDA,float * B, int LDB, float *C, int LDC, float *D, int LDD,
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_reorder,SLA_TGCSYLV_L2_REORDER)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_local_copy
...
void mepack_single_tgcsylv_level2_local_copy(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        float * A, int LDA,float * B, int LDB, float *C, int LDC, float *D, int LDD,
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_local_copy,SLA_TGCSYLV_L2_LOCAL_COPY)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_local_copy_32
...
void mepack_single_tgcsylv_level2_local_copy_32(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        float * A, int LDA,float * B, int LDB, float *C, int LDC, float *D, int LDD,
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    Int _LDA  = LDA;
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_local_copy_32,SLA_TGCSYLV_L2_LOCAL_COPY_32)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_local_copy_64
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_local_copy_64,SLA_TGCSYLV_L2_LOCAL_COPY_64)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_local_copy_96
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_local_copy_96,SLA_TGCSYLV_L2_LOCAL_COPY_96)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_l2_local_copy_128
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_l2_local_copy_128,SLA_TGCSYLV_L2_LOCAL_COPY_128)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;

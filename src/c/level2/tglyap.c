...
/**
 ...
 \remark This function is a wrapper around \ref dla_tglyap_l2.
 ...
 \date October 2023
 */
void mepack_double_tglyap_level2(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tglyap_l2,DLA_TGLYAP_L2)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref dla_tglyap_l2_unopt.

 \see dla_tglyap_l2_unopt
 ...
 \date October 2023
 */
void mepack_double_tglyap_level2_unopt(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    Int _M   = M;
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(dla_tglyap_l2_unopt,DLA_TGLYAP_L2_UNOPT)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_l2.
 ...
 \date October 2023
 */
void mepack_single_tglyap_level2(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tglyap_l2,SLA_TGLYAP_L2)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_l2_unopt.

 \see sla_tglyap_l2_unopt
 ...
 \date October 2023
 */
void mepack_single_tglyap_level2_unopt(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    Int _M   = M;
    Int _LDA = LDA;
    ...
    FC_GLOBAL_(sla_tglyap_l2_unopt,SLA_TGLYAP_L2_UNOPT)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);

...
double mepack_double_residual_lyap(const char * TRANS, int M, double *A, int LDA, double *X, int LDX,
        double *Y, int LDY, double SCALE)
{
    ...
    return FC_GLOBAL_(dla_residual_lyap, DLA_RESIDUAL_LYAP) (TRANS, &_M, A, &_LDA, X, &_LDX, Y, &_LDY, &SCALE, c1len);
}
...
float mepack_single_residual_lyap(const char * TRANS, int M, float *A, int LDA, float *X, int LDX,
        float *Y, int LDY, float SCALE)
{
    ...
    return FC_GLOBAL_(sla_residual_lyap, SLA_RESIDUAL_LYAP) (TRANS, &_M, A, &_LDA, X, &_LDX, Y, &_LDY, &SCALE, c1len);
}

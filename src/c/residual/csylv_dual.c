...
double mepack_double_residual_csylv_dual(const char * TRANSA, const char *TRANSB, double sgn1, double sgn2, int M, int N, double *A, int LDA,
        ...
        double *E, int LDE, double *F, int LDF, double SCALE)
{
    ...
    return FC_GLOBAL_(dla_residual_csylv_dual, DLA_RESIDUAL_CSYLV_DUAL) (TRANSA, TRANSB, &sgn1, &sgn2, &_M, &_N,
...
float mepack_single_residual_csylv_dual(const char * TRANSA, const char *TRANSB, float sgn1, float sgn2, int M, int N, float *A, int LDA,
        ...
        float *E, int LDE, float *F, int LDF, float SCALE)
{
    ...
    return FC_GLOBAL_(sla_residual_csylv_dual, SLA_RESIDUAL_CSYLV_DUAL) (TRANSA, TRANSB, &sgn1, &sgn2, &_M, &_N,
            A, &_LDA, B, &_LDB, C, &_LDC, D, &_LDD,
            R, &_LDR, L, &_LDL, E, &_LDE, F, &_LDF, &SCALE, c1len, c2len);
}

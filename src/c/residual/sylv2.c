 ...
 */
/**
 \brief Compute the relative residual for the discrete-time Sylvester equation.
...
double mepack_double_residual_sylv2(const char * TRANSA, const char *TRANSB, double sgn, int M, int N, double *A, int LDA,
        double *B, int LDB, double *X, int LDX, double *Y, int LDY, double SCALE)
{
    ...
    return FC_GLOBAL_(dla_residual_sylv2, DLA_RESIDUAL_SYLV2) (TRANSA, TRANSB, &sgn, &_M, &_N, A, &_LDA, B, &_LDB, X, &_LDX, Y, &_LDY, &SCALE, c1len, c2len);
}
...
float mepack_single_residual_sylv2(const char * TRANSA, const char *TRANSB, float sgn, int M, int N, float *A, int LDA,
        float *B, int LDB, float *X, int LDX, float *Y, int LDY, float SCALE)
{
    ...
    return FC_GLOBAL_(sla_residual_sylv2, SLA_RESIDUAL_SYLV2) (TRANSA, TRANSB, &sgn, &_M, &_N, A, &_LDA, B, &_LDB, X, &_LDX, Y, &_LDY, &SCALE, c1len, c2len);
}

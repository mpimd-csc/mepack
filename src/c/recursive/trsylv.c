...
/**
 ...
 \remark This function is a wrapper around \ref dla_trsylv_recursive.

 \see dla_trsylv_recursive
...
void mepack_double_trsylv_recursive(const char *TRANSA, const char *TRANSB, double SGN,  int M, int N,
                                 ...
                                 double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_trsylv_recursive,DLA_TRSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN, &_M, &_N,
...
/**
 ...
 \remark This function is a wrapper around \ref sla_trsylv_recursive.

 \see sla_trsylv_recursive
...
void mepack_single_trsylv_recursive(const char *TRANSA, const char *TRANSB, float SGN,  int M, int N,
                                 ...
                                 float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_trsylv_recursive,SLA_TRSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO;
    return;
}

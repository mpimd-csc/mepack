 ...
 */
/**
 \brief Recursive blocking Algorithm for the generalized Sylvester equation
 ...
 \remark This function is a wrapper for \ref dla_tgsylv_recursive.

 \see dla_tgsylv_recursive
 ...
 \date January 2024
*/
void mepack_double_tgsylv_recursive(const char *TRANSA, const char*TRANSB, double SGN,
        ...
        double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgsylv_recursive,DLA_TGSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 ...
 \remark This function is a wrapper for \ref sla_tgsylv_recursive.

 \see sla_tgsylv_recursive
 ...
 \date January 2024
*/
void mepack_single_tgsylv_recursive(const char *TRANSA, const char*TRANSB, float SGN,
        ...
        float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgsylv_recursive,SLA_TGSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, X, &_LDX, SCALE, WORK, &_INFO, c1len, c2len);

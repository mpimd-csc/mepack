...
/**
 \brief Recursive blocking Algorithm for the generalized coupled Sylvester equation
 ...
 \remark The function is a wrapper for \ref dla_tgcsylv_recursive

 \see dla_tgcsylv_recursive
...
void mepack_double_tgcsylv_recursive(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_recursive,DLA_TGCSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 ...
 \remark The function is a wrapper for \ref sla_tgcsylv_recursive

 \see sla_tgcsylv_recursive
 ...
 \date October 2023
*/
void mepack_single_tgcsylv_recursive(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_recursive,SLA_TGCSYLV_RECURSIVE)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;

...
/**
 ...
 \remark This function is a wrapper for \ref dla_tgcsylv_dual_recursive.

 \see dla_tgcsylv_dual_recursive
...
void mepack_double_tgcsylv_dual_recursive(const char *TRANSA, const char*TRANSB, double SGN1, double SGN2,  int M, int N,
        ...
        double *E, int LDE, double *F, int LDF ,  double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tgcsylv_dual_recursive,DLA_TGCSYLV_DUAL_RECURSIVE)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
...
/**
 ...
 \remark This function is a wrapper for \ref sla_tgcsylv_dual_recursive.

 \see sla_tgcsylv_dual_recursive
 ...
 \date January 2024
*/
void mepack_single_tgcsylv_dual_recursive(const char *TRANSA, const char*TRANSB, float SGN1, float SGN2,  int M, int N,
        ...
        float *E, int LDE, float *F, int LDF ,  float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tgcsylv_dual_recursive,SLA_TGCSYLV_DUAL_RECURSIVE)(TRANSA, TRANSB, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB,
            C, &_LDC, D, &_LDD, E, &_LDE, F, &_LDF, SCALE, WORK, &_INFO, c1len, c2len);
    *INFO = (int) _INFO ;
    return;

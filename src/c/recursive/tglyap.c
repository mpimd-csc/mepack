...
/**
 ...
 \brief Recursive blocking Level-3 Bartels-Stewart Algorithm for the generalized Lyapunov equation
 ...
 \remark This function is a wrapper around \ref dla_tglyap_recursive.
 ...
 \date Januar 2023
 */
void mepack_double_tglyap_recursive(const char *TRANS, int M, double * A, int LDA, double * B, int LDB, double *X, int LDX,
                              double * SCALE, double *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_tglyap_recursive,DLA_TGLYAP_RECURSIVE)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);
...
/**
 ...
 \remark This function is a wrapper around \ref sla_tglyap_recursive.
 ...
 \date Januar 2023
 */
void mepack_single_tglyap_recursive(const char *TRANS, int M, float * A, int LDA, float * B, int LDB, float *X, int LDX,
                              float * SCALE, float *WORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_tglyap_recursive,SLA_TGLYAP_RECURSIVE)(TRANS, &_M, A, &_LDA, B, &_LDB, X, &_LDX, SCALE, WORK, &_INFO, c1len);

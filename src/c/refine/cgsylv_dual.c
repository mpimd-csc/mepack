...
/**
 ...
 \endverbatim
 \remark This function is a wrapper for \ref dla_ggcsylv_dual_refine.

 \see dla_ggcsylv_dual_refine
 ...
 \date January 2024
*/
void mepack_double_ggcsylv_dual_refine(const char * TRANSA, const char * TRANSB, const char *GUESS, double SGN1, double SGN2, int M, int N , double * A, int LDA,
        ...
        int *MAXIT, double *TAU, double *CONVLOG, double * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_ggcsylv_dual_refine, DLA_GGCSYLV_DUAL_REFINE) (TRANSA, TRANSB, GUESS, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB, C, &_LDC, D, &_LDD,
...
/**
 ...
 \endverbatim
 \remark This function is a wrapper for \ref sla_ggcsylv_dual_refine.

 \see sla_ggcsylv_dual_refine
 ...
 \date January 2024
*/
void mepack_single_ggcsylv_dual_refine(const char * TRANSA, const char * TRANSB, const char *GUESS, float SGN1, float SGN2, int M, int N , float * A, int LDA,
        ...
        int *MAXIT, float *TAU, float *CONVLOG, float * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_ggcsylv_dual_refine, SLA_GGCSYLV_DUAL_REFINE) (TRANSA, TRANSB, GUESS, &SGN1, &SGN2, &_M, &_N, A, &_LDA, B, &_LDB, C, &_LDC, D, &_LDD,
            R, &_LDR, L, &_LDL, E, &_LDE, F, &_LDF, AS, &_LDAS, BS, &_LDBS, CS, &_LDCS, DS, &_LDDS,
            Q, &_LDQ, Z, &_LDZ, U, &_LDU, V, &_LDV,
            &_MAXIT, TAU, CONVLOG, WORK, &_LDWORK, &_INFO, c1len, c2len, c3len);

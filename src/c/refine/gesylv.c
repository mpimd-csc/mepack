...
/**
 ...
 \remark This function is a wrapper for \ref dla_gesylv_refine

 \see dla_gesylv_refine
 ...
 \date Dezember 2022
*/
void mepack_double_gesylv_refine(const char * TRANSA, const char * TRANSB, const char *GUESS, double SGN, int M, int N , double * A, int LDA,
        ...
        int *MAXIT, double *TAU, double *CONVLOG, double * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_gesylv_refine, DLA_GESYLV_REFINE) (TRANSA, TRANSB, GUESS, &SGN, &_M, &_N, A, &_LDA, B, &_LDB, X, &_LDX, Y, &_LDY, AS, &_LDAS, BS, &_LDBS,
            Q, &_LDQ, U, &_LDU,
...
/**
 ...
 \remark This function is a wrapper for \ref sla_gesylv_refine

 \see sla_gesylv_refine
 ...
 \date Dezember 2022
*/
void mepack_single_gesylv_refine(const char * TRANSA, const char * TRANSB, const char *GUESS, float SGN, int M , int N,  float * A, int LDA,
        ...
        int *MAXIT, float *TAU, float *CONVLOG, float * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_gesylv_refine, SLA_GESYLV_REFINE) (TRANSA, TRANSB, GUESS, &SGN, &_M, &_N, A, &_LDA, B, &_LDB, X, &_LDX, Y, &_LDY, AS, &_LDAS, BS, &_LDBS,
            Q, &_LDQ, U, &_LDU,
            &_MAXIT, TAU, CONVLOG, WORK, &_LDWORK, &_INFO, c1len, c2len, c3len);

...
/**
 ...
 \remark This function is a wrapper for dla_GELYAP_refine.

 \see dla_GELYAP_refine
        ...
        int *MAXIT, double *TAU, double *CONVLOG, double * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_gelyap_refine, DLA_GELYAP_REFINE) (TRANS, GUESS, &_M, A, &_LDA, X, &_LDX, Y, &_LDY, AS, &_LDAS, Q, &_LDQ,
...
/**
 ...
 \remark This function is a wrapper for sla_gelyap_refine.

 \see sla_gelyap_refine
        ...
        int *MAXIT, float *TAU, float *CONVLOG, float * WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_gelyap_refine, SLA_GELYAP_REFINE) (TRANS, GUESS, &_M, A, &_LDA, X, &_LDX, Y, &_LDY, AS, &_LDAS, Q, &_LDQ,
            &_MAXIT, TAU, CONVLOG, WORK, &_LDWORK, &_INFO, c1len, c2len);

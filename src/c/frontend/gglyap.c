...
/**
 ...
 \remark This function is a wrapper for \ref dla_gglyap.
        ...
        double * SCALE, double *WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(dla_gglyap,DLA_GGLYAP)(FACT, TRANS, &_M, A, &_LDA, B, &_LDB, Q, &_LDQ, Z, &_LDZ, X, &_LDX, SCALE, WORK, &_LDWORK, &_INFO, c1len, c2len);
...
/**
 ...
 \remark This function is a wrapper for \ref sla_gglyap.
...
void mepack_single_gglyap(const char * FACT, const char *TRANS, int M, float * A,  int LDA, float *B, int LDB,
        ...
        float * SCALE, float *WORK, size_t LDWORK, int *INFO)
{
    ...
    FC_GLOBAL_(sla_gglyap,SLA_GGLYAP)(FACT, TRANS, &_M, A, &_LDA, B, &_LDB, Q, &_LDQ, Z, &_LDZ, X, &_LDX, SCALE, WORK, &_LDWORK, &_INFO, c1len, c2len);

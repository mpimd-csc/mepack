...
/**
 ...
 \remark This function is a wrapper for \ref dla_gesylv.
 ...
 \date Dezember 2022
*/
void mepack_double_gesylv(const char *FACTA, const char *FACTB, const char *TRANSA, const char*TRANSB, double SGN,  int M, int N,
        ...
        double * SCALE, double *WORK, size_t LDWORK, int* INFO)
{
    ...
    FC_GLOBAL_(dla_gesylv,DLA_GESYLV)( FACTA, FACTB, TRANSA, TRANSB, &SGN, &_M, &_N,
...
/**
 ...
 \remark This function is a wrapper for \ref sla_gesylv.
 ...
 \date Dezember 2022
*/
void mepack_single_gesylv(const char *FACTA, const char *FACTB, const char *TRANSA, const char*TRANSB, float SGN,  int M, int N,
        ...
        float * SCALE, float *WORK, size_t LDWORK, int* INFO)
{
    ...
    FC_GLOBAL_(sla_gesylv,SLA_GESYLV)( FACTA, FACTB, TRANSA, TRANSB, &SGN, &_M, &_N,
            A, &_LDA, B, &_LDB, QA, &_LDQA, QB, &_LDQB, X, &_LDX,
            SCALE, WORK, &_LDWORK, &_INFO,
            c1len, c2len, c3len, c4len);
    *INFO = (int) _INFO;

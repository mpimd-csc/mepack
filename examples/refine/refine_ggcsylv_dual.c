...
void usage(char *prgmname) {
    int is;
    printf("Solve a dual generalized coupled Sylvester equation with iterative refinement.\n");
    printf("\n");
...
#pragma omp parallel for schedule(static,1)
            ...
            mem = mepack_memory_frontend("DLA_GGCSYLV_DUAL_REFINE", "N", "N", M, N);
            ...
            for (mat = 0; mat < nMAT; mat++) {
                ...
                benchmark_rhs_ggcsylv_dual_double(TRANSA, TRANSB, sign1, sign2,  M, N, Aorig, M, Borig, N, Corig, M, Dorig, N, Rorig, M, Lorig, M,  RHS_R, M, RHS_L, M );
                ...
                for (run = -1; run < RUNS; run++) {
                    ...
                    Int ldwork = mem;
                        ...
                        ts = get_wtime();
                        ts2 = get_ctime();
                        mepack_double_ggcsylv_dual_refine(TRANSA, TRANSB, "N", sign1, sign2,  M, N, Aorig, M, Borig, N, Corig, M, Dorig, N,  R, M, L, M, RHS_R, M, RHS_L, M,
                    ...
                    res += mepack_double_residual_csylv_dual(TRANSA, TRANSB, sign1, sign2, M, N, Aorig, M, Borig, N, Corig, M, Dorig, N, R, M, L, M, RHS_R, M, RHS_L, M, 1.0);

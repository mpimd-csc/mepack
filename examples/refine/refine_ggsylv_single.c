...
void usage(char *prgmname) {
    int is;
    printf("Solve a generalized Sylvester equation with iterative refinement in single precision.\n");
    printf("\n");
...
#pragma omp parallel for schedule(static,1)
            ...
            mem = mepack_memory_frontend("SLA_GGSYLV_REFINE", "N", "N", M, N);
            ...
            for (mat = 0; mat < nMAT; mat++) {
                ...
                benchmark_rhs_gsylv_float(TRANSA, TRANSB, sign,  M, N, Aorig, M, Borig, N, Corig, M, Dorig, N, Xorig, M, RHS, M );
                ...
                for (run = -1; run < RUNS; run++) {
                    ...
                    mepack_single_ggsylv_refine(TRANSA, TRANSB, "N", sign,  M, N, Aorig, M, Borig, N, Corig, M, Dorig, N,  X, M, RHS, M,
                ...
                res += mepack_single_residual_gsylv(TRANSA, TRANSB, sign, M, N, Aorig, M, Borig, N, Corig, M, Dorig, N, X, M, RHS, M, 1.0);

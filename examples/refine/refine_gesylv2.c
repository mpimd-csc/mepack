...
void usage(char *prgmname) {
    int is;
    printf("Solve a discrete-time Sylvester equation with iterative refinement.\n");
    printf("\n");
...
#pragma omp parallel for schedule(static,1)
            ...
            mem = mepack_memory_frontend("DLA_GESYLV2_REFINE", "N", "N", M, N);
            ...
            for (mat = 0; mat < nMAT; mat++) {
                ...
                benchmark_rhs_sylv2_double(TRANSA, TRANSB, sign,  M, N, Aorig, M, Borig, N, Xorig, M, RHS, M );
                ...
                for (run = 0; run < RUNS; run++) {
                    ...
                    mepack_double_gesylv2_refine( TRANSA, TRANSB, "N", sign, M, N, Aorig, M, Borig, N, X, M, RHS, M,
                ...
                res += mepack_double_residual_sylv2(TRANSA, TRANSB, sign, M, N, Aorig, M, Borig, N, X, M, RHS, M, 1.0);

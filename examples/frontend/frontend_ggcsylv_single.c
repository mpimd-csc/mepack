...
void usage(char *prgmname) {
    int is;
    printf("Solve a generalized coupled Sylvester equation with different solvers in single precision.\n");
    printf("\n");
...
#pragma omp parallel for schedule(static,1)
            ...
            for (mat = 0; mat < nMAT; mat++) {
                ...
                benchmark_rhs_ggcsylv_float(TRANSA, TRANSB, sign1, sign2,  M, N, A, M, B, N, C, M, D, N,Xorig, M , Yorig, M, RHS,M , RHS2, M );
                ...
                for (run = -1; run < RUNS; run++) {
                    ...
                    if ( run == -1 || !reuse) {
                        if ( hess ) {
                            mepack_single_ggcsylv("H", "H", TRANSA, TRANSB, sign1, sign2,  M, N, A, M, B, N, C, M, D, N,  QA, M, ZA, M, QB, N, ZB, N, X, M, Y, M,  &scale, Work, ldwork, &info);
                        } else {
                            mepack_single_ggcsylv("N", "N", TRANSA, TRANSB, sign1, sign2,  M, N, A, M, B, N, C, M, D, N,  QA, M, ZA, M, QB, N, ZB, N, X, M, Y, M,  &scale, Work, ldwork, &info);
                        }
                    } else {
                        mepack_single_ggcsylv("F", "F", TRANSA, TRANSB, sign1, sign2,  M, N, A, M, B, N, C, M, D, N,  QA, M, ZA, M, QB, N, ZB, N, X, M, Y, M,  &scale, Work, ldwork, &info);
                    }
                ...
                res += mepack_single_residual_csylv(TRANSA, TRANSB, sign1, sign2, M, N, Aorig, M, Borig, N, Corig, M, Dorig, N, X, M, Y, M, RHS, M, RHS2, M, scale);

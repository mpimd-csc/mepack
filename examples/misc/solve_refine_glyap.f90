...
PROGRAM RUN_REFINE_GLYAP
    ...
    EXTERNAL DGEMM, DLA_GGLYAP_REFINE
    ...
    CALL DGEMM(TRANSA, "N", M, M, M, ONE, A, M, Y, M, ZERO, WORK, M)
    CALL DGEMM("N", TRANSB, M, M, M, -ONE, WORK, M, C, M, ONE, X, M)
    CALL DGEMM(TRANSA, "N", M, M, M, ONE, C, M, Y, M, ZERO, WORK, M)
    CALL DGEMM("N", TRANSB, M, M, M, -ONE, WORK, M, A, M, ONE, X, M)

    RES2 = DLANGE("F", M, M, X, M, WORK)
    ...
    WRITE(*,'(I5," ",I3, " ", D20.13," ",D20.13," ",D20.13)') M, MAXIT, TALL, RES/NRMX, RES2/NRMRHS
